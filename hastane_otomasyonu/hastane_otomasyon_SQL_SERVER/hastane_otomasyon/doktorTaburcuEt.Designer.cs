namespace hastane_otomasyon
{
    partial class doktorTaburcuEt
    {
        ...
        private void InitializeComponent()
        {
			...
			// dateTimePicker1
			// 
			this.dateTimePicker1.Location = new System.Drawing.Point(140, 97);
			...
			// dateTimePicker2
			// 
			this.dateTimePicker2.Location = new System.Drawing.Point(140, 54);
			...
			this.Name = "doktorTaburcuEt";
			this.Text = "Taburcu Etme Formu";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.doktorTaburcuEt_FormClosing);
