...
{
    partial class doktorNakilGonder
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "Nakil Olacak Hastanın TC si :";
			// 
			// textBox1
			// 
			...
			this.label2.Text = "Nakil Edilen Yer :";
			// 
			// button2
			// 
			...
			this.Name = "doktorNakilGonder";
			this.Text = "doktorNakilGonder";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.doktorNakilGonder_FormClosing);
			this.Load += new System.EventHandler(this.doktorNakilGonder_Load);
